...
public class ServiceException extends RuntimeException {
    ...
    public ServiceException(ServiceExceptionEnum exceptionCodeEnum) {
        super(String.valueOf(exceptionCodeEnum.getCode()));
        this.errorCode = exceptionCodeEnum.getCode();
        this.errorMsg = exceptionCodeEnum.getMessage();
    }
